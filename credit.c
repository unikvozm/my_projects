...
int main(void)
{
    ...
    if (cc_number < 4000000000000 || (50000000000000 <= cc_number && cc_number < 340000000000000) || (350000000000000 <= cc_number && cc_number< 370000000000000) || (380000000000000 <= cc_number && cc_number< 4000000000000000) || (5000000000000000 <= cc_number && cc_number < 5100000000000000) || cc_number >= 5600000000000000)
    {
        printf("INVALID\n");
    }
    else
